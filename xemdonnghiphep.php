                                     ...
                                     if(mysqli_num_rows($result)==0)
                                      ...
                                      else
                                      {
                                        ...
                                        echo "<tr style='color:blue;'>
                                                    ...
                                                    <td><img src='img/delete.jpg' width='30px' height='30px'></td>
                                              </tr>";
                                        while ($row = mysqli_fetch_array($result))
                                        {
                                                $id = $row['Id'];
                                                if($row['ChoPhepNghi'] == 'no')
                                                    ...
                                                    echo "<td>{$row['MaNV']}</td>
                                                            ...
                                                            <td>
                                                                <a href='sualichnghiphepUser.php?id=$id'><button class='btn' id='btn'>Sửa</button></a>
                                                                <a href='xoalichnghiphepUser.php?id=$id'><button class='btn' id='btn'>Xóa</button></a>
