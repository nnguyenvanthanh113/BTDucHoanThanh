...
<?php 
  ...
  if(isset($_POST['xoa']))
  {
   	 ...
   	 $sql = "DELETE FROM lichnghi
            
            WHERE Id='$id'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_query($conn, $sql))
				{
					echo "<script>alert('Xóa lịch nghỉ thành công')</script>";						
				}
				else
					echo "<script>alert('Xóa lịch nghỉ thất bại')</script>";
				echo "<script>location.replace('lichnghinhanvien.php');</script>";
  }
?>
  <!-- /.control-sidebar -->
   <div class="content-wrapper">          
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <h1 class="m-0 text-dark">XÓA LỊCH NGHỈ PHÉP NHÂN VIÊN</h1>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div class="col-lg-12 col-md-12  col-sx-12">
                          <form action="#" method="post">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                  <input type="date" class="form-control" name="ngaybatdaunghi" value="<?php echo $ngaybatdaunghi;?>" required="required" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Số ngày nghỉ</label>
                                <div class="col-sm-4">
                                  <input type="number" class="form-control" name="songaynghi" value="<?php echo $songaynghi; ?>" required="required" readonly>
                                </div>
                              </div>                       
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                   <div class="form-group">
                                        <textarea class="form-control rounded-0" name="lydo" rows="3" required="required" readonly><?php echo $lydo;?></textarea>
                                   </div>
                                </div>
                              </div>
                              <div class="form-group row">
