        ...
        <div class="content-wrapper">          
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <h1 class="m-0 text-dark" style="color:red !important;">Lịch Công Tác Nhân Viên</h1>
                  </div>
                </div>
              </div>
            </div>
					        ...
					        <div id='table'>
					            <?php 
                                    ...
                                    $result = mysqli_query($conn,$sqli) or die('could not seclect');
                                     if(mysqli_num_rows($result)==0)
                                        echo "chua co lịch công tác nào !";
                                      else
                                      {
                                        echo "<table border='1'>";
                                        ...
                                        while ($row = mysqli_fetch_array($result))
                                        {
                                                $id = $row['Id'];
                                                    ...
                                                    echo "<td>{$row['MaNV']}</td>
                                                            ...
                                                            <td>{$row['NgayDi']}</td>
                                                            <td>{$row['NgayVe']}</td>
                                                            <td>{$row['NoiCongTac']}</td>
                                                            <td>{$row['PhuongTienDiChuyen']}</td>
                                                            <td>{$row['NoiDung']}</td>
                                                            <td>
                                                                <a href='sualichcongtacUser.php?id=$id'><button class='btn' id='btn'>Sửa</button></a>
                                                                <a href='xoalichcongtacUser.php?id=$id'><button class='btn' id='btn'>Xóa</button></a>
