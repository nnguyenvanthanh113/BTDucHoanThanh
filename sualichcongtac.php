...
<?php 
  ...
  if(isset($_POST['sua']))
  {
  		$sql = "UPDATE lichcongtac
						SET NgayDi='$ngaydi',NgayVe='$ngayve',NoiCongTac='$noicongtac',PhuongTienDiChuyen='$phuongtien',NoiDung='$noidung'
						WHERE Id='$id'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_query($conn, $sql))
				{
					echo "<script>alert('Sửa lịch công tác thành công')</script>";						
				}
				else
					echo "<script>alert('Sửa lịch công tác thất bại')</script>";
                        ...
                        <div class="col-lg-12 col-md-12  col-sx-12">
                          <form action="#" method="post">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                  <input type="date" class="form-control" name="ngaydi" value="<?php echo $ngaydi;?>" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Ngày về</label>
                                <div class="col-sm-4">
                                  <input type="date" class="form-control" name="ngayve" value="<?php echo $ngayve; ?>" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nơi công tác</label>
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" name="noicongtac" value="<?php echo $noicongtac; ?>" placeholder="nơi công tác" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Phương tiện di chuyển</label>
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" name="phuongtien" value="<?php echo $phuongtien; ?>" placeholder="phương tiện di chuyển" required="required">
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                   <div class="form-group">
                                        <textarea class="form-control rounded-0" name="noidung" rows="3" required="required"><?php echo $noidung;?></textarea>
                                   </div>
                                </div>
                              </div>
                              <div class="form-group row">
